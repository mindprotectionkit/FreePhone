...
import com.mindprotectionkit.freephone.monitor.MonitorConfigUpdateReceiver;
import com.mindprotectionkit.freephone.ui.ApplicationPreferencesActivity;
import com.mindprotectionkit.freephone.ui.CallControls;
import com.mindprotectionkit.freephone.ui.CallScreen;
import com.mindprotectionkit.freephone.ui.QualityReporting;
  ...
  private void sendInstallLink(String user) {
    String message =
        String.format(getString(R.string.RedPhone_id_like_to_call_you_securely_using_redphone_you_can_install_redphone_from_the_play_store_s),
                                "https://play.google.com/store/apps/details?id=com.mindprotecionkit.freephone");
