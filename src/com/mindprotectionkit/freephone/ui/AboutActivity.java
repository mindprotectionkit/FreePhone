...
public class AboutActivity extends SherlockActivity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    TextView attributionTextView = (TextView)findViewById(R.id.attributionText);
    attributionTextView.setText("FreePhone is based on RedPhone, which is GPL licensed. \n\n"+getString(R.string.about_activity__attributionText));
